<%-- 
    ...
    Created on : 21/11/2020, 12:48:04
    Author     : Leonardo
--%>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="well well-sm">
                            <form class="form-horizontal appointment-form" action="" method="post">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="name" name="name" type="text" placeholder="Seu nome" class="form-control light">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="email" type="email" name="email" type="text" placeholder="Seu email" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="message" name="mensagem" placeholder="Digite sua mensagem para nós..." rows="5"></textarea>
                                        </div>
                                    </div>
