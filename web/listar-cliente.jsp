            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-12 appointment ftco-animate">
                            ...
                            <table border="1" class="table table-dark">
                                ...
                                <c:forEach items="${clientes}" var="cliente">
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary py-3 px-4" href="CarregarCliente?id=${cliente.id}">
                                                Alterar</a></td>
                                        <td>
                                            <a class="btn btn-primary py-3 px-4" onclick="if (confirm('Confirma a exclusão?')) {
                                                        window.location.href = `ExcluirCliente?id=${cliente.id}`
                                                    }">Excluir</a>
                                        </td>
                        ...
                        <br><a href="cadastrar-cliente.jsp">Voltar</a>
                    </div>
                </div>
            </div>
