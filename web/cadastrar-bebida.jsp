<%-- 
    Document   : cadastrar-bebida
    Created on : 25/09/2020, 19:25:26
    Author     : Leonardo
--%>
       ...
       <!--Seção para Barra de Navegação-->
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-6 appointment ftco-animate">
                        ...
                        <h5>${msg}</h5>
                        <form method="POST" action="CadastrarBebida" class="appointment-form">
                            <input type="hidden" name="idProduto" value="${bebida.idProduto}"/>
                            Descrição<input value="${bebida.descricao}" class="form-control" type="text" name="descricao" required/><br>
                            Tipo<select class="form-control" name="tipo" required>
                                <option ${bebida.tipo == 'cerveja' ? 'selected' : ''} class="bg-dark" value="cerveja">Cerveja</option>
                                <option ${bebida.tipo == 'vinho' ? 'selected' : ''} class="bg-dark" value="vinho">Vinho</option>
                                <option ${bebida.tipo == 'refrigerante' ? 'selected' : ''} class="bg-dark" value="refrigerante">Refrigerante</option>
                                <option ${bebida.tipo == 'outros' ? 'selected' : ''} class="bg-dark" value="outros">Outros</option>
                            </select><br>
                            Data Validade<input value="${bebida.dataValidade}" class="form-control" type="date" name="dataValidade" required/><br>
                            Medida<input value="${bebida.medida}" class="form-control" type="number" name="medida" required/><br>
                            Valor<input value="${bebida.valor}" id="valor" class="form-control" type="number" name="valor" required/><br>
                            <input type="submit" value="Salvar" class="btn btn-primary py-3 px-4">
                            <a class="btn btn-primary py-3 px-4" href="ListarBebida">Lista de Bebidas</a>
                        </form>
        ...
        <script>
                                      $(document).ready(function () {
                                          ...
                                          $seuCampoValor.mask('00.00', {reverse: true});
                                      });
        </script>
