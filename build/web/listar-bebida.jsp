<%-- 
    Document   : listar-bebida
    Created on : 01/10/2020, 22:07:16
    Author     : Leonardo
--%>
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-12 appointment ftco-animate">
                            ...
                            <c:forEach items="${bebidas}" var="bebida">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <td>${bebida.medida}</td>
                                    <td>${bebida.valor}</td>
                                    <td><a class="btn btn-primary py-3 px-4" href="CarregarBebida?idProduto=${bebida.idProduto}">Alterar</a></td>
                                    <td><a class="btn btn-primary py-3 px-4" onclick="if (confirm('Confirma a exclusão?')) {
                                                window.location.href = 'ExcluirBebida?idProduto=${bebida.idProduto}'
                                            }">Excluir</a></td>
                                </tr>
                        ...
                        <br><a href="cadastrar-bebida.jsp">Voltar</a>
                    </div>
                </div>
            </div>
