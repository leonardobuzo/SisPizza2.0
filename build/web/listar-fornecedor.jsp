<%-- 
    ...
    Created on : 03/10/2020, 13:11:13
    Author     : Leonardo
--%>
                    ...
                    <div class="col-md-12 appointment ftco-animate">
                        ...
                        <table border="1" class="table table-dark">
                            ...
                            <c:forEach items="${fornecedores}" var="fornecedor">
                                <tr>
                                    <td>${fornecedor.idPessoa}</td>
                                    <td>${fornecedor.nome}</td>
                                    <td>${fornecedor.email}</td>
                                    <td>${fornecedor.telefone}</td>
                                    <td>${fornecedor.cnpj}</td>
                                    <td><a class="btn btn-primary py-3 px-4" href="CarregarFornecedor?idPessoa=${fornecedor.idPessoa}">Alterar</a></td>
                                    <td><a class="btn btn-primary py-3 px-4" onclick="if (confirm('Confirma a exclusão?')) {
                                                window.location.href = 'ExcluirFornecedor?idPessoa=${fornecedor.idPessoa}'}">Excluir</a></td>
                                </tr>

                            </c:forEach>

                        </table>
                        <br><a href="cadastrar-fornecedor.jsp">Voltar</a>
                    </div>
                </div>
            </div>
