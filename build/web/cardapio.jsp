<%-- 
    Document   : cardapio
    Created on : 31/10/2020, 12:32:51
    Author     : Leonardo
--%>
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3 mt-5 pt-5">
                    <div class="col-md-7 heading-section text-center ftco-animate">
                        ...
                        <p class="mt-5">Compare os valores de outros sabores de pizzas e peça agora mesmo a sua!</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="pricing-entry d-flex ftco-animate">
                            ...
                            <div class="desc pl-3">
                                <div class="d-flex text align-items-center">
                                    <h3><span>Pizza de Bacon Crispy</span></h3>
                                    <span class="price">R$59,90</span>
                                </div>
                                <div class="d-block">
                                    <p>A small river named Duden flows by their place and supplies</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="pricing-entry d-flex ftco-animate">
                            ...
                            <div class="desc pl-3">
                                <div class="d-flex text align-items-center">
                                    <h3><span>Amanteigada &amp; Abacaxi</span></h3>
                                    <span class="price">R$79,90</span>
                                </div>
                                <div class="d-block">
                                    <p>A small river named Duden flows by their place and supplies</p>
