...
<!--Seção para Barra de Navegação-->
        ...
        <!--Seção para LOGIN DO FUNCIONARIO-->
            ...
            <div class="container-wrap">
                <div class="row no-gutters d-md-flex align-items-center">
                    ...
                    <div class="col-md-6 appointment ftco-animate">
                        <h3 class="mb-3">Acesso Funcionário</h3>
        ...
        <!--Seção para CADASTRAR FUNCIONARIO-->
        <section class="ftco-section" id="historia">
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-6 appointment ftco-animate">
                        <h3 class="mb-3">Cadastro do Funcionário</h3>
                        <h5>${mensagem}</h5>
                        <form action="CadastrarFuncionario" method="POST" class="appointment-form">
                            ...
                            <div class="d-me-flex">
                                <div class="form-group">
                                    Salário<input value="${funcionario.salario}" id="salario" type="number" name="salario" class="form-control" placeholder="Salario" required>
                                </div>
                            </div>
                            <div class="d-me-flex">
                                <div class="form-group">
                            ...
                            <div>
                                ...
                                <a class="btn btn-primary py-3 px-4" href="listar-funcionario.jsp">Lista de Funcionários</a>
                            </div>
                        </form>
                    </div>
