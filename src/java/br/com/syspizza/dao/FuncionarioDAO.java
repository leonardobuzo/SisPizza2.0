...
public class FuncionarioDAO implements GenericDAO{
    ...
    public Boolean cadastrar(Object object) throws Exception {
        ...
        try{
            String sql = "insert into funcionario (nome, salario, telefone) values (?,?,?);";
    ...
    public List<Object> listar() throws Exception {
        ...
        try{
            ...
            while(rs.next()){
                ...
                funcionario.setNome(rs.getString("nome").toUpperCase());
    ...
    public Boolean alterar(Object object) throws Exception {
        ...
        try{
            String sql = "update funcionario set nome = ?, salario = ?, telefone = ? "
                        + "where id = ?;";
            Funcionario funcionario = (Funcionario) object;
            stmt = this.conn.prepareStatement(sql);
    ...
    public Boolean excluir(Integer id) throws Exception {
        ...
        try{
            ...
            retorno = false;
            System.out.println("Erro ao escluir funcionárioDAO " + e.getMessage());
        }finally{
            ConnectionFactory.fecharConexao(conn, stmt,rs);
        }
        return retorno;
