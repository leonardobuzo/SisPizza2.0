...
import br.com.syspizza.util.Funcoes;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Double valor = Double.parseDouble(request.getParameter("valor"));
                   ...
                   bebida.setTipo(tipo);
                   bebida.setDataValidade(Funcoes.converterStringDate(dataValidade));
                   ...
                   if(dao.cadastrar(bebida)){
                    ...
                    request.getRequestDispatcher("cadastrar-bebida.jsp").forward(request, response);
                   }else{
                    ...
                    request.getRequestDispatcher("CarregarBebida").forward(request, response);
                }
