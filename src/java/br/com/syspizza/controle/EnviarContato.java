...
public class EnviarContato extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            envioEmail.setHostName("smtp.gmail.com");
            envioEmail.addTo("syspizza.teste@gmail.com"); //destinatario
            envioEmail.setFrom(email);                    //remetente
            envioEmail.setSubject("Contato - SysPizza");  //assunto
            envioEmail.setMsg("Nome: "+ nome + "\n" +
                              "Email:"+ email + "\n" +
                              "Mensagem: "+ mensagem);    //mensagem
            
            envioEmail.setAuthentication("syspizza.teste@gmail.com", "syspizza123"); //usuario e senha
